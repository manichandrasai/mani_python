...
# print(read_json_file('imdb_assignment/imdb_movies.json'))

# print(top_dir_with_max_movies('imdb_assignment/imdb_movies.json'))
# print(popular_genere_watched_by_most('imdb_assignment/imdb_movies.json'))
# print(get_top_ten_movies_by_imdb_score('imdb_assignment/imdb_movies.json'))
# print(least_watched_movie_by_imdb_score('imdb_assignment/imdb_movies.json'))
